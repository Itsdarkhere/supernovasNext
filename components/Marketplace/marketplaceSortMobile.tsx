...
const MarketplaceSortMobile = () => {
    ...
    // [@leftBarAnimation]
    //         *ngIf="globalVars.isMarketplaceLeftBarMobileOpen"
    return (
        <div
            className={styles.left_bar_mobile__flyout_div_marketplace + " disable-scrollbars"}
            >
            <div className={styles.max_width_400px + " d-flex flex-center disable-scrollbars"}>
