...
const MarketplaceEthSortMobile = ({ flyout }) => {
    ...
    // [@leftBarAnimation]
    // *ngIf="globalVars.isEthMarketplaceLeftBarMobileOpen"
    return (
        <div
        className="left-bar-mobile__flyout-div-marketplace overflow-hidden disable-scrollbars d-flex flex-center"
        >
