...
const WithdrawEth = () => {
  return (
    <>
      ...
      {/* *ngIf="!this.pendingWithdrawals && !this.readyWithdrawals && !this.completeWithdrawalSuccess" */}
      <div className="withdraw-eth-wrapper d-flex flex-column flex-center-start h-100">
        ...
        {/* (click)="prepareWithdrawButtonClicked()" */}
        <button className="imx-withdraw-button">
      ...
      <div className="withdraw-eth-wrapper d-flex flex-column flex-center-start h-100">
        ...
        <button className="imx-complete-withdraw-button">
          <div className="withdraw-eth-text">Withdraw from Immutable X</div>
        </button>
      </div>

      {/* <!-- completed withdrawals --> */}
      {/* *ngIf="this.completeWithdrawalSuccess" */}
      <div className="withdraw-eth-wrapper d-flex flex-column flex-center-start h-100">
        <div className="withdraw-eth-icon-container">
          <img
            className="eth-logo-withdraw-icon d-flex flex-row flex-center"
