...
export const imxSlice = createSlice({
  ...
  reducers: {
    ...
    setIsEthereumNFTForSale: (state, action: PayloadAction<boolean>) => {
      state.isEthereumNFTForSale = action.payload;
    },
...
export const { setIMXClient, setIMXWalletAddress, setIsEthereumNFTForSale } = imxSlice.actions;
