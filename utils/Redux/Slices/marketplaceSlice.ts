...
export const marketplaceSlice = createSlice({
  ...
  reducers: {
    ...
    pushToETHMarketplaceNFTsData: (
      ...
      // Check works
      state.ethMarketplaceNFTsData = state.ethMarketplaceNFTsData.concat(
        action.payload
      );
    },
...
export const {
  ...
  setETHMarketplaceNFTsData,
  setETHMarketplaceNFTsDataToShow,
  setMarketplaceNFTsOffset,
  addToMarketplaceNFTsOffset,
  setEthMarketplaceNFTsOffset,
  addToEthMarketplaceNFTsOffset,
...
export const selectMarketplace = (state: AppState) =>
  state.sort.desoMarketplace;
