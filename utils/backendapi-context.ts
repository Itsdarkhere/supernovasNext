...
export class BackendApiService {
  ...
  post(endpoint: string, path: string, body: any): Observable<any> {
    return this.ax
      .post(this._makeRequestURL(endpoint, path), body)
      .pipe(catchError(this._handleError));
  }
  ...
  GetBase64Nonce(endpoint: string): Observable<any> {
    return this.ax.get<any>(this.GetBase64NonceURL(endpoint), {});
  }
  GetBase64NonceURL(endpoint: string): string {
    return this._makeRequestURL(
      endpoint,
      BackendRoutes.RoutePathGetBase64Nonce
    );
  }
  GetIMXMetadatById(endpoint: string): Observable<any> {
    return this.ax.get<any>(this.GetIMXMetadataURL(endpoint), {});
  }
  ...
  UpdateIMXMetadataPostHash(
    ...
    return this.post(
      endpoint,
      BackendRoutes.RoutePathUpdateIMXMetadataPostHash,
      {
        Token_id,
        PostHashHex,
      }
  ...
  GetBitcoinAPIInfo(bitcoinAddr: string, isTestnet: boolean): Observable<any> {
    ...
    return this.ax.get<any>(endpoint).pipe(
      map((res) => {
        ...
        for (let ii = 0; ii < res.data.txs.length; ii++) {
          txnPromises.push(this.getAllTransactionOutputs(res.data.txs[ii]));
        }
  ...
  AcceptNFTTransfer(
    ...
    this.mixPanel.track70("On-chain activity");
    return this.signAndSubmitTransaction(
      endpoint,
      request,
      UpdaterPublicKeyBase58Check
  ...
  GetNFTShowcaseSupernovas(
    ...
    return this.post(
      endpoint,
      BackendRoutes.RoutePathGetNFTShowcaseSupernovas,
      {
        UserPublicKeyBase58Check,
        ReaderPublicKeyBase58Check,
      }
  ...
  ReportPostEmail(endpoint: string, ReportedContent: string): Observable<any> {
    return this.post(endpoint, BackendRoutes.RoutePathReportPostEmail, {
      ReportedContent,
    });
  }
  AddToInvestorEmailList(endpoint: string, Email: string): Observable<any> {
    return this.post(endpoint, BackendRoutes.RoutePathAddToInvestorEmailList, {
      Email,
    });
  }
  GetCurrentTime(
    ...
    return this.post(endpoint, BackendRoutes.RoutePathGetCurrentTime, {
      ReaderPublicKeyBase58Check,
    });
  }
  // Get nft trade list
  GetNFTTradeList(
    ...
    return this.post("https://api.overdeso.com/v1", "", [
      {
        method: method,
        params: {
          hash,
  ...
  GetAllUserCollectionNames(
    ...
    return this.post(
      endpoint,
      BackendRoutes.RoutePathGetAllUserCollectionNames,
      {
        Username,
      }
    );
  ...
  UpdateCollectorOrCreator(
    ...
    return this.post(
      endpoint,
      BackendRoutes.RoutePathUpdateCollectorOrCreator,
      {
        PublicKeyBase58Check,
        Creator,
        Collector,
  ...
  InsertOrUpdateProfileDetails(
    ...
    return this.post(
      endpoint,
      BackendRoutes.RoutePathInsertOrUpdateProfileDetails,
      {
        PublicKeyBase58Check,
        Twitter,
        Website,
  ...
  GetUnreadNotificationsCount(
    ...
    return this.post(
      endpoint,
      BackendRoutes.RoutePathGetUnreadNotificationsCount,
      {
        PublicKeyBase58Check,
      }
    );
